...
ActiveRecord::Schema[7.1].define(version: 2024_12_29_154854) do
  ...
  create_table "commentaires", force: :cascade do |t|
    ...
    t.index ["service_id"], name: "index_commentaires_on_service_id"
  ...
  add_foreign_key "commentaires", "services"
